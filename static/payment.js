...
<div class="card-header">
            <h5 class="text-uppercase">Seleccione modo de pago.</h5>
Tenga en cuenta que algunas pueden generar gastos adicionales.
</div>
<div class="card-body">
                            ...
                            <div class="panel-group payments-method" id="accordion">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="float-end">
                                            <i style="font-size: 40px" class="fa fa-cc-paypal text-success mr-lg-5"></i>
                                        </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="float-end">
                                            <i style="font-size: 40px" class="fa fa-cc-amex text-success"></i>
                                            <i style="font-size: 40px" class="fa fa-cc-mastercard text-warning"></i>
                                            <i style="font-size: 40px" class="fa fa-cc-discover text-danger"></i>
                                        </div>
                                        <h5 class="panel-title">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <span class="input-group-addon"><i style="font-size: 40px" class="fa fa-credit-card ml-3"></i></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
